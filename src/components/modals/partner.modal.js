      ...
      const loaddata = async() =>{
        ...
        switch(alertType){
          case 'create':
            ...
            const data = await axios.post(`${process.env.URL_API}/api/partner/create`,formdata)
          ...
          default:
            ...
            const dataUp = await axios.put(`${process.env.URL_API}/api/partner/update/${dataLoad._id}`,formdata)
    ...
    <>
      ...
      } 
      {
        ...
        <li className='flex flex-col mb-9'>
          <label className='font-semibold'>Tên đối tác*</label>
