    ...
    useEffect(()=>{
        ...
        if(checkLoad && funcAll.read && funcAll.pathname === document.location.pathname)
        {
            const loaddata = async()=>{
                const data = await axios.get(`${process.env.URL_API}/api/partner/list`)
    ...
    <>
        ...
        <div className='bg-white p-4 h-5/6 rounded-md'>
            <div className='flex justify-between'>
                <h1 className='font-semibold text-2xl'>Tất cả đối tác</h1>
                <div className='w-1/3'>
            ...
            <div className='table px-8 pt-4 w-full' >
                    ...
                    <tr className='h-12'>
                                ...
                                <th className='w-1/4'>Tên đối tác</th>
        ...
        {
            tabModal?
            <LayoutModal children={<PartnerModal setCheckLoad={setCheckLoad} dataTab={dataTab} setTab={setTabModal} typeModal={typeModal}/>}/> : ''
        }
    </>
  )
}
